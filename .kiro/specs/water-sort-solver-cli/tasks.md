...
- [x] 1.3 CLIArgs・ValidationResult・エラー型の定義
...
- [x] 7. テストの実装
- [x] 7.1 (P) models.py と parser.py の単体テスト
...
- [x] 7.2 (P) validator.py と formatter.py の単体テスト
